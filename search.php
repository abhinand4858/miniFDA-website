				...
				<div class="col-md-12 col-md-offset-0 text-left">
					...
					<div class="row row-mt-15em">
					    ...
					    <form class="form-signin" action="query.php" method="post">
					      ...
					      <input type="text" class="form-control" name="query1" placeholder="drug name" required="" autofocus="" /><br>
					      <button class="btn btn-lg btn-success btn-block" type="submit" name="btn-search1">Search</button>
					    </form>
					    <div align="center">
					    <br><br><br><br>
