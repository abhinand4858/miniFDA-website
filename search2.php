...
<link rel="shortcut icon" type="image/png" href="images/logo.png"/>
    ...
    <form class="form-signin" action="query.php" method="post">
      ...
      <input type="text" class="form-control" name="query2" placeholder="drug name" required="" autofocus="" /><br>
      <button class="btn btn-lg btn-success btn-block" type="submit" name="btn-search2">Search</button>
    </form>
    <div align="center">
					    <br><br><br><br>
